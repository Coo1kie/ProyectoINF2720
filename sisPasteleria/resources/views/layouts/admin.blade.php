...
<html>
  <head>
    ...
    <title>PASTELERIA BROWNIE</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>BRW</b>V</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Pasteleria BROWNIE</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Pasteleria BROWNIE</span>
                </a>
            ...
            <li class="treeview">
             ...
             <li class="treeview">
              <a href="#">
               ...
               <ul class="treeview-menu">
                <li><a href="{{url('reporte/pdf')}}"><i class="fa fa-circle-o"></i>Reporte Venta</a></li>
